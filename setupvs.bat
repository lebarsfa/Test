...
wget "https://aka.ms/vs/15/release/vs_buildtools.exe" -O vs_buildtools.exe >> out.log
...
vs_buildtools.exe modify --installPath "C:\Program Files (x86)\Microsoft Visual Studio\2017\BuildTools" --passive --norestart --wait --includeRecommended --add Microsoft.VisualStudio.ComponentGroup.NativeDesktop.WinXP --add Microsoft.VisualStudio.Component.WinXP >> out.log
echo Exit Code is %errorlevel% >> out.log
exit
